...
subtitle = news.find('a', attrs={'class': 'gui-color-primary gui-color-hover feed-post-body-title bstn-relatedtext'})

topic = news.find('span')

print('\033[1;34m↓↓Código HTML da noticia↓↓\033[0;0m')
print(title.prettify()) # Metodo que organiza o codigo html em algo mais legivel 
